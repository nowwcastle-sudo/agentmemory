...
| GET | `/agentmemory/graph/rejected` |
| GET | `/agentmemory/graph/relations-index` |
| POST | `/agentmemory/graph/relations-index/rebuild` |
| POST | `/agentmemory/graph/reset` |
| POST | `/agentmemory/graph/snapshot-rebuild` |
| GET | `/agentmemory/graph/stats` |
| POST | `/agentmemory/graph/stats-recount` |
| POST | `/agentmemory/graph/summary-judgments` |
| POST | `/agentmemory/graph/type-backfill` |
| GET | `/agentmemory/health` |
| POST | `/agentmemory/import` |
| POST | `/agentmemory/index/reconcile` |
| POST | `/agentmemory/insight-index/rebuild` |
...
| POST | `/agentmemory/session/checkpoint` |
