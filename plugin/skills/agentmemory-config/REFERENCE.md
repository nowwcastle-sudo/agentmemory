...
Configuration is read from the environment and from `~/.agentmemory/.env` (no `export` prefix). 56 recognized variables:

- `AGENTMEMORY_AGENT_SCOPE`
- `AGENTMEMORY_ALLOW_AGENT_SDK`
- `AGENTMEMORY_AUDIT_INDEX_PERSIST`
- `AGENTMEMORY_AUTO_COMPRESS`
- `AGENTMEMORY_AUTO_SUMMARIZE`
...
- `AGENTMEMORY_GRAPH_CACHE_TTL_MS`
- `AGENTMEMORY_GRAPH_MIN_QUERY_TOKENS`
- `AGENTMEMORY_GRAPH_MODE`
...
- `AGENTMEMORY_INDEX_DIR`
- `AGENTMEMORY_INDEX_SAVE_DEBOUNCE_MS`
- `AGENTMEMORY_INJECT_CONTEXT`
- `AGENTMEMORY_LLM_ACQUIRE_TIMEOUT_MS`
- `AGENTMEMORY_LLM_MAX_CONCURRENCY`
- `AGENTMEMORY_LLM_NOTHINK`
- `AGENTMEMORY_LLM_TIMEOUT_MS`
- `AGENTMEMORY_MCP_BLOCK`
- `AGENTMEMORY_METRICS_PORT`
- `AGENTMEMORY_OUTBOX_DIR`
- `AGENTMEMORY_OUTBOX_SCAN_LIMIT`
- `AGENTMEMORY_OUTBOX_TICK_ACCEPT`
- `AGENTMEMORY_PROBE_TIMEOUT_MS`
- `AGENTMEMORY_PROJECTION_CONCURRENCY`
- `AGENTMEMORY_PROJECTION_RECOVERY_INTERVAL_MS`
- `AGENTMEMORY_PROJECT_NAME`
- `AGENTMEMORY_PROVIDER`
- `AGENTMEMORY_REFLECT`
- `AGENTMEMORY_RUNTIME_DIR`
